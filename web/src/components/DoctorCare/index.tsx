import './styles.css';
import blackWomanImg from '../../assets/black-woman-with-green-sweater-with-both-hands-on-chest.png'
import doctorImg from '../../assets/happy-doctor-holding-a-clipboard-with-patients.png'
import blackManImg from '../../assets/black-man-with-beige-sweater-using-cellphone.png'
import { useEffect } from 'react';
import ScrollReveal from 'scrollreveal';


export function DoctorCare() {
  ...
  function showBackToTopButtonOnScroll() {
    const backToTopButton = document.querySelector('#backToTopButton') as HTMLInputElement
  ...
  function activateMenuAtCurrentSection() {
    ...
    sections.map(section => {
      const sectionGetElement = document.querySelector(`#${section}`) as HTMLInputElement
  
      const sectionTop = sectionGetElement.offsetTop
      const sectionHeight = sectionGetElement.offsetHeight
    ...
    <>
      <nav id="navigation">
        <div className="wrapper">
          ...
          <div className="menu">
            <ul>
              <li><a onClick={handleCloseMenu} href="#home">Início</a></li>
              <li><a onClick={handleCloseMenu} href="#services">Serviços</a></li>
              <li><a onClick={handleCloseMenu} href="#about">Sobre</a></li>
            </ul>

            <a className="button" href="#contact" onClick={handleCloseMenu}>
              Agende sua consulta
            </a>
                ...
                <a href="https://instagram.com" target="_blank">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="#FFFAF1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path
                      ...
                      stroke="#FFFAF1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M17.5 6.5H17.51" stroke="#FFFAF1" strokeWidth="2" strokeLinecap="round"
                ...
                <a href="https://youtube.com" target="_blank">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="#FFFAF1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M9.75 15.02L15.5 11.75L9.75 8.47998V15.02Z" stroke="#FFFAF1" strokeWidth="2"
          ...
          <button className="open-menu" onClick={handleOpenMenu} aria-label="Open menu" aria-expanded="false">
          ...
          <button className="close-menu" onClick={handleCloseMenu} aria-expanded="true" aria-label="Close menu">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section id="home">
        <div className="wrapper">
          ...
          <div className="col-b">
            <img src={blackWomanImg}
              alt="Mulher negra vestindo moletom verde e sorrindo com as mãos na frente do peito" />
          </div>
          ...
          <div className="content">
            <div className="card">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M17.091 8.18182L10.091 15.1818L6.90918 12" stroke="#00856F" strokeWidth="1.5"
                  strokeLinecap="round" strokeLinejoin="round" />
              </svg>

              <h3>Problemas digestivos</h3>
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cum accusantium sequi fugiat repellendus vel?
                Nulla
                quam voluptatem reiciendis, corrupti nisi harum magnam maxime incidunt rem ea maiores ipsam temporibus
                nobis.
              </p>
            </div>
            <div className="card">
      ...
      <section id="about">
        <div className="wrapper">
          <div className="col-a">
            ...
            <div className="content">
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos praesentium ex placeat unde, totam
                vitae itaque corporis officiis blanditiis sit nesciunt, possimus nihil vero a, veniam perspiciatis autem
                enim
                animi?</p>
          ...
          <div className="col-b">
            <img src={doctorImg}
              alt="Imagem de um médico feliz segurando uma prancheta com pacientes" />
          </div>
        </div>
      </section>
        ...
        <div className="wrapper">
          <div className="col-a">
            ...
            <div className="content">
                ...
                <li>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="#00856F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path
                ...
                <li>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z"
                      stroke="#00856F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M22 6L12 13L2 6" stroke="#00856F" strokeWidth="2" strokeLinecap="round"
                      strokeLinejoin="round" />
                  </svg>
              ...
              <a className="button" href="https://wa.me/5511987654321" target="_blank">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div className="col-b">
            <img src={blackManImg}
              alt="Homem negro vestindo moletom bege mexendo no celular e sorrindo" />
          </div>
        </div>
      </section>
